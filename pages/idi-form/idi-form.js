...
Page({
  ...
  getSubmitParams () {
    return {
      ...
      doorTime: this.data.comeDateTimeValue ? this.formatDate(new Date(this.data.comeDateTimeValue), 'yyyy-MM-dd hh:mm:ss') : null,
      insuranceTime: this.data.insuranceTimeValue ? this.formatDate(new Date(this.data.insuranceTimeValue), 'yyyy-MM-dd hh:mm:ss') : null,
      ...
      insuranceTimeLimit: this.data.expireDateTimeValue ? this.formatDate(new Date(this.data.expireDateTimeValue), 'yyyy-MM-dd hh:mm:ss') : null,
      insuranceTimeLimitEnd: this.data.expireDateTimeEndValue ? this.formatDate(new Date(this.data.expireDateTimeEndValue), 'yyyy-MM-dd hh:mm:ss') : null,
